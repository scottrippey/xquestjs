...
setTimeout(c._handleTimeout,c._interval)}};c._tick=function(){var a=c._getTime();c._ticks++;var m=a-c._lastTime,b=c._paused;b&&(c._pausedTicks++,c._pausedTime+=m);c._lastTime=a;for(var d=a-c._startTime,m={type:"tick",paused:b,delta:m,time:d,runTime:d-c._pausedTime,ticks:this._ticks,runTicks:this._ticks-this._pausedTicks},d=c._pauseable,e=c._listeners.slice(),f=e?e.length:0,g=0;g<f;g++){var j=e[g];null==j||b&&d[g]||(j.tick?j.tick(m):j instanceof Function&&j(m))}c.dispatchEvent(m);for(c._tickTimes.unshift(c._getTime()-
a);100<c._tickTimes.length;)c._tickTimes.pop();for(c._times.unshift(a);100<c._times.length;)c._times.pop()};var b=window.performance&&(performance.now||performance.mozNow||performance.msNow||performance.oNow||performance.webkitNow);c._getTime=function(){return b&&b.call(performance)||(new Date).getTime()};c.init();createjs.Ticker=c})();this.createjs=this.createjs||{};
...
(function(){var c=function(a,m,b,d,e,c){this.initialize(a,m,b,d,e,c)},b=c.prototype;c.identity=null;c.DEG_TO_RAD=Math.PI/180;b.a=1;b.b=0;b.c=0;b.d=1;b.tx=0;b.ty=0;b.alpha=1;b.shadow=null;b.compositeOperation=null;b.initialize=function(a,m,b,d,e,c){null!=a&&(this.a=a);this.b=m||0;this.c=b||0;null!=d&&(this.d=d);this.tx=e||0;this.ty=c||0;return this};b.prepend=function(a,m,b,d,e,c){var g=this.tx;if(1!=a||0!=m||0!=b||1!=d){var j=this.a,k=this.c;this.a=j*a+this.b*b;this.b=j*m+this.b*d;this.c=k*a+this.d*
b;this.d=k*m+this.d*d}this.tx=g*a+this.ty*b+e;this.ty=g*m+this.ty*d+c;return this};b.append=function(a,b,h,d,c,f){var g=this.a,j=this.b,k=this.c,l=this.d;this.a=a*g+b*k;this.b=a*j+b*l;this.c=h*g+d*k;this.d=h*j+d*l;this.tx=c*g+f*k+this.tx;this.ty=c*j+f*l+this.ty;return this};b.prependMatrix=function(a){this.prepend(a.a,a.b,a.c,a.d,a.tx,a.ty);this.prependProperties(a.alpha,a.shadow,a.compositeOperation);return this};b.appendMatrix=function(a){this.append(a.a,a.b,a.c,a.d,a.tx,a.ty);this.appendProperties(a.alpha,
